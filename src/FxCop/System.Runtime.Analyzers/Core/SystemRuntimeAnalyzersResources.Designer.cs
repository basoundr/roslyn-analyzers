...
namespace System.Runtime.Analyzers {
    ...
    internal class SystemRuntimeAnalyzersResources {
        ...
        /// </summary>
        internal static string TypesShouldNotExtendCertainBaseTypes {
            get {
                return ResourceManager.GetString("TypesShouldNotExtendCertainBaseTypes", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Change the base type of {0} so that it no longer extends {1}.
        /// </summary>
